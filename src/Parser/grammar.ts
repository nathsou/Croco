...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "if", "symbols": ["logical"], "postprocess": id},
    {"name": "logical", "symbols": ["logical", {"literal":"&&"}, "comp"], "postprocess": ([as, _, bs]) => App(App(Fun("And"), as), bs)},
    {"name": "logical", "symbols": ["logical", {"literal":"||"}, "comp"], "postprocess": ([as, _, bs]) => App(App(Fun("Or"), as), bs)},
    {"name": "logical", "symbols": ["comp"], "postprocess": id},
    ...
    {"name": "custom_op", "symbols": ["custom_op", (lexer.has("backtick") ? {type: "backtick"} : backtick), (lexer.has("symb") ? {type: "symb"} : symb), (lexer.has("backtick") ? {type: "backtick"} : backtick), "addsub"], "postprocess": d => App(App(Fun(d[2].value), d[0]), d[4])},
    ...
    {"name": "lazy", "symbols": ["term", {"literal":"?"}], "postprocess": ([t, _]) => Fun("Lazy", t)},
    {"name": "lazy", "symbols": [{"literal":"("}, "expr", {"literal":")"}, {"literal":"?"}], "postprocess": d => Fun("Lazy", d[1])},
